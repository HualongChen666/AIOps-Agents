# -*- coding: utf-8 -*-
"""FastAPI application for the Terraform IaC microservice."""
...
from .service import TerraformIaCService as ServiceClass
...
app = FastAPI(
    title="Terraform IaC Service",
    description="FastAPI microservice for Terraform IaC.",
    version="0.1.0",
)
...
@app.post("/terraform-iac/{path}", response_model=FeatureResponse)
