# -*- coding: utf-8 -*-
"""FastAPI application for the Prometheus Integration microservice."""
...
from .service import PrometheusIntegrationService as ServiceClass
...
app = FastAPI(
    title="Prometheus Integration Service",
    description="FastAPI microservice for Prometheus Integration.",
    version="0.1.0",
)
...
@app.post("/prometheus-integration/{path}", response_model=FeatureResponse)
