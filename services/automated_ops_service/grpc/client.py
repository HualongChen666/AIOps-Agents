# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Automated Operations microservice."""
...
class AutomatedOperationsServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9566") -> None:
