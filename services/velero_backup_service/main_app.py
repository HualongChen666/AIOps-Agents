# -*- coding: utf-8 -*-
"""FastAPI application for the Velero Backup microservice."""
...
from .service import VeleroBackupService as ServiceClass
...
app = FastAPI(
    title="Velero Backup Service",
    description="FastAPI microservice for Velero Backup.",
    version="0.1.0",
)
...
@app.post("/velero-backup/{path}", response_model=FeatureResponse)
