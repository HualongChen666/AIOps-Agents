# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Datacenter Visualization microservice."""
...
class DatacenterVisualizationServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9545") -> None:
