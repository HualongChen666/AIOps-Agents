# -*- coding: utf-8 -*-
"""FastAPI application for the Automated Deployment microservice."""
...
from .service import AutomatedDeploymentService as ServiceClass
...
app = FastAPI(
    title="Automated Deployment Service",
    description="FastAPI microservice for Automated Deployment.",
    version="0.1.0",
)
...
@app.post("/automated-deployment/{path}", response_model=FeatureResponse)
