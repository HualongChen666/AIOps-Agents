# -*- coding: utf-8 -*-
"""FastAPI application for the Chaos Mesh microservice."""
...
from .service import ChaosMeshService as ServiceClass
...
app = FastAPI(
    title="Chaos Mesh Service",
    description="FastAPI microservice for Chaos Mesh.",
    version="0.1.0",
)
...
@app.post("/chaos-mesh/{path}", response_model=FeatureResponse)
