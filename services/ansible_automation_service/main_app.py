# -*- coding: utf-8 -*-
"""FastAPI application for the Ansible Automation microservice."""
...
from .service import AnsibleAutomationService as ServiceClass
...
app = FastAPI(
    title="Ansible Automation Service",
    description="FastAPI microservice for Ansible Automation.",
    version="0.1.0",
)
...
@app.post("/ansible-automation/{path}", response_model=FeatureResponse)
