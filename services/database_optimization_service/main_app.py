# -*- coding: utf-8 -*-
"""FastAPI application for the Database Optimization microservice."""
...
from .service import DatabaseOptimizationService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Database Optimization.",
    version="0.1.0",
)
...
@app.post("/database-optimization/{path}", response_model=FeatureResponse)
