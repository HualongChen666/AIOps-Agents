# -*- coding: utf-8 -*-
"""FastAPI application for the FastAPI Security microservice."""
...
from .service import FastAPISecurityService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for FastAPI Security.",
    version="0.1.0",
)
...
@app.post("/fastapi-security/{path}", response_model=FeatureResponse)
