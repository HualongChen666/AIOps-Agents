# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the FastAPI Security microservice."""
...
class FastAPISecurityServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9540") -> None:
