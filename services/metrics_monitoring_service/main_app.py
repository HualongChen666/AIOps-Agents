# -*- coding: utf-8 -*-
"""FastAPI application for the Metrics Monitoring microservice."""
...
from .service import MetricsMonitoringService as ServiceClass
...
app = FastAPI(
    title="Metrics Monitoring Service",
    description="FastAPI microservice for Metrics Monitoring.",
    version="0.1.0",
)
...
@app.post("/metrics-monitoring/{path}", response_model=FeatureResponse)
