# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Metrics Monitoring microservice."""
...
class MetricsMonitoringServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9568") -> None:
