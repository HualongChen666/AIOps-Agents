# -*- coding: utf-8 -*-
"""FastAPI application for the Elasticsearch Audit microservice."""
...
from .service import ElasticsearchAuditService as ServiceClass
...
app = FastAPI(
    title="Elasticsearch Audit Service",
    description="FastAPI microservice for Elasticsearch Audit.",
    version="0.1.0",
)
...
@app.post("/elasticsearch-audit/{path}", response_model=FeatureResponse)
