# -*- coding: utf-8 -*-
"""FastAPI application for the Distributed Tracing microservice."""
...
from .service import DistributedTracingService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Distributed Tracing.",
    version="0.1.0",
)
...
@app.post("/distributed-tracing/{path}", response_model=FeatureResponse)
