# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Distributed Tracing microservice."""
...
class DistributedTracingServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9569") -> None:
