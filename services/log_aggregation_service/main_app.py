# -*- coding: utf-8 -*-
"""FastAPI application for the Log Aggregation microservice."""
...
from .service import LogAggregationService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Log Aggregation.",
    version="0.1.0",
)
...
@app.post("/log-aggregation/{path}", response_model=FeatureResponse)
