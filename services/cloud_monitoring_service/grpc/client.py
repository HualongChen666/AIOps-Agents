# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Cloud Monitoring microservice."""
...
class CloudMonitoringServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9534") -> None:
