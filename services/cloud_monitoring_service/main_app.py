# -*- coding: utf-8 -*-
"""FastAPI application for the Cloud Monitoring microservice."""
...
from .service import CloudMonitoringService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Cloud Monitoring.",
    version="0.1.0",
)
...
@app.post("/cloud-monitoring/{path}", response_model=FeatureResponse)
