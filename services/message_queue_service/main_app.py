# -*- coding: utf-8 -*-
"""FastAPI application for the Message Queue microservice."""
...
from .service import MessageQueueService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Message Queue.",
    version="0.1.0",
)
...
@app.post("/message-queue/{path}", response_model=FeatureResponse)
