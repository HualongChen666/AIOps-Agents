# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the pgBackRest Backup microservice."""
...
class pgBackRestBackupServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9544") -> None:
