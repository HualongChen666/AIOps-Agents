# -*- coding: utf-8 -*-
"""FastAPI application for the pgBackRest Backup microservice."""
...
from .service import pgBackRestBackupService as ServiceClass
...
app = FastAPI(
    title="pgBackRest Backup Service",
    description="FastAPI microservice for pgBackRest Backup.",
    version="0.1.0",
)
...
@app.post("/pgbackrest-backup/{path}", response_model=FeatureResponse)
