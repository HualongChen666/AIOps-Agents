# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Grafana Integration microservice."""
...
class GrafanaIntegrationServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9531") -> None:
