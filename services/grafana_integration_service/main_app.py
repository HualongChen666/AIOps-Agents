# -*- coding: utf-8 -*-
"""FastAPI application for the Grafana Integration microservice."""
...
from .service import GrafanaIntegrationService as ServiceClass
...
app = FastAPI(
    title="Grafana Integration Service",
    description="FastAPI microservice for Grafana Integration.",
    version="0.1.0",
)
...
@app.post("/grafana-integration/{path}", response_model=FeatureResponse)
