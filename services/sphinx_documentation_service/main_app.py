# -*- coding: utf-8 -*-
"""FastAPI application for the Sphinx Documentation microservice."""
...
from .service import SphinxDocumentationService as ServiceClass
...
app = FastAPI(
    title="Sphinx Documentation Service",
    description="FastAPI microservice for Sphinx Documentation.",
    version="0.1.0",
)
...
@app.post("/sphinx-documentation/{path}", response_model=FeatureResponse)
