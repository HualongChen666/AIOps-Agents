# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Incident Response microservice."""
...
class IncidentResponseServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9553") -> None:
