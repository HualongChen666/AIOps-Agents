# -*- coding: utf-8 -*-
"""FastAPI application for the Capacity Planning microservice."""
...
from .service import CapacityPlanningService as ServiceClass
...
app = FastAPI(
    title="Capacity Planning Service",
    description="FastAPI microservice for Capacity Planning.",
    version="0.1.0",
)
...
@app.post("/capacity-planning/{path}", response_model=FeatureResponse)
