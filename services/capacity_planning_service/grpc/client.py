# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Capacity Planning microservice."""
...
class CapacityPlanningServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9548") -> None:
