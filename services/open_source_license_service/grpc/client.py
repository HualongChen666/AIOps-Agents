# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Open Source License microservice."""
...
class OpenSourceLicenseServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9555") -> None:
