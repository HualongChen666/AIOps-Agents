# -*- coding: utf-8 -*-
"""FastAPI application for the Tracing microservice."""
...
from .service import TracingService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Tracing.",
    version="0.1.0",
)
...
@app.post("/tracing/{path}", response_model=FeatureResponse)
