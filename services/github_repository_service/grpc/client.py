# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the GitHub Repository microservice."""
...
class GitHubRepositoryServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9554") -> None:
