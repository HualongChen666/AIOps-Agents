# -*- coding: utf-8 -*-
"""FastAPI application for the ELK Stack microservice."""
...
from .service import ELKStackService as ServiceClass
...
app = FastAPI(
    title="ELK Stack Service",
    description="FastAPI microservice for ELK Stack.",
    version="0.1.0",
)
...
@app.post("/elk-stack/{path}", response_model=FeatureResponse)
