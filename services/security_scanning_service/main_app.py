# -*- coding: utf-8 -*-
"""FastAPI application for the Security Scanning microservice."""
...
from .service import SecurityScanningService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Security Scanning.",
    version="0.1.0",
)
...
@app.post("/security-scanning/{path}", response_model=FeatureResponse)
