# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Security Scanning microservice."""
...
class SecurityScanningServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9563") -> None:
