# -*- coding: utf-8 -*-
"""FastAPI application for the Performance Monitoring microservice."""
...
from .service import PerformanceMonitoringService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Performance Monitoring.",
    version="0.1.0",
)
...
@app.post("/performance-monitoring/{path}", response_model=FeatureResponse)
