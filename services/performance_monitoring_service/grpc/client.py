# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Performance Monitoring microservice."""
...
class PerformanceMonitoringServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9560") -> None:
