# -*- coding: utf-8 -*-
"""FastAPI application for the Plugin System microservice."""
...
from .service import PluginSystemService as ServiceClass
...
app = FastAPI(
    title="Plugin System Service",
    description="FastAPI microservice for Plugin System.",
    version="0.1.0",
)
...
@app.post("/plugin-system/{path}", response_model=FeatureResponse)
