...
from tests.benchmarks.benchmark_base import PerformanceResult, PerformanceMetricType
...
class RegressionTestHelper:
    ...
    def check_regression(self, test_name: str, metric_type: str,
    ...
    def check_performance_result(self, performance_result: PerformanceResult,
                                metric_type: PerformanceMetricType) -> RegressionResult:
        """
    ...
    def assert_regression_below_severity(self, result: RegressionResult, 
...
class RegressionTestMixin:
    ...
    def check_performance_regression(self, test_name: str, metric_type: str,
                                    current_values: List[float]) -> RegressionResult:
        """
        Check for performance regression
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "regression: mark test for regression detection"
    )
    config.addinivalue_line(
        "markers", "baseline: mark test to establish baseline"
    )
    config.addinivalue_line(
        "markers", "noregression: disable regression detection for this test"
    )
...
class CIRegressionChecker:
    ...
    def check_and_report(self, test_name: str, metric_type: str,
...
def main():
    ...
    parser.add_argument("--establish-baseline", action="store_true", help="Establish baseline instead of checking")
