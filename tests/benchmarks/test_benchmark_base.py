...
class TestPerformanceMetricsCollector:
    ...
    def test_add_custom_sample_without_metadata(self):
        ...
        collector.add_custom_sample(
            metric_type=PerformanceMetricType.CPU_USAGE, value=50.0, unit="percent"
        )
...
class TestPerformanceResultAnalyzer:
    ...
    def test_analyzer_initialization(self):
        ...
        samples = [MetricSample(datetime.now(), PerformanceMetricType.CPU_USAGE, 50.0, "percent")]
        result = PerformanceResult(
            test_name="test",
            start_time=datetime.now(),
            end_time=datetime.now(),
    ...
    def test_detect_anomalies_with_outliers(self):
        ...
        samples = [
            ...
            MetricSample(
                datetime.now(), PerformanceMetricType.CPU_USAGE, 200.0, "percent"
            ),  # Extreme outlier
        ]
        result = PerformanceResult(
            test_name="test",
        ...
        anomalies = analyzer.detect_anomalies(
            PerformanceMetricType.CPU_USAGE, std_dev_threshold=1.0
        )
