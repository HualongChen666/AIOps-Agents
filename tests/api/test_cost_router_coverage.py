...
def mock_cost_functions():
    ...
    return {"collect_costs": Mock(), "forecast_costs": Mock(), "budget_status": Mock()}
...
class TestGetCollect:
    ...
    def test_get_collect_large_dataset(self, client, mock_cost_functions):
        ...
        mock_cost_data = [{"date": f"2026-07-{i:02d}", "amount": 100.0 + i} for i in range(1, 32)]
        mock_cost_functions["collect_costs"].return_value = mock_cost_data
...
class TestGetForecast:
    ...
    def test_get_forecast_long_period(self, client, mock_cost_functions):
        ...
        mock_forecast_data = [
            {"date": f"2026-07-{i:02d}", "predicted_amount": 100.0 + i} for i in range(1, 366)
        ]
        mock_cost_functions["forecast_costs"].return_value = mock_forecast_data
...
class TestGetBudget:
    ...
    def test_get_budget_success(self, client, mock_cost_functions):
        ...
        mock_budget_data = {"budget": 1000.0, "used": 500.0, "remaining": 500.0, "status": "normal"}
    ...
    def test_get_budget_zero_usage(self, client, mock_cost_functions):
        ...
        mock_budget_data = {"budget": 1000.0, "used": 0.0, "remaining": 1000.0, "status": "normal"}
        mock_cost_functions["budget_status"].return_value = mock_budget_data
    ...
    def test_get_budget_full_usage(self, client, mock_cost_functions):
        ...
        mock_budget_data = {"budget": 1000.0, "used": 1000.0, "remaining": 0.0, "status": "normal"}
        mock_cost_functions["budget_status"].return_value = mock_budget_data
    ...
    def test_get_budget_with_recommendations(self, client, mock_cost_functions):
        ...
        mock_budget_data = {
            ...
            "remaining": 400.0,
            "status": "normal",
            "recommendations": ["Optimize resource usage", "Consider reserved instances"],
        }
        mock_cost_functions["budget_status"].return_value = mock_budget_data
    ...
    def test_get_budget_with_breakdown(self, client, mock_cost_functions):
        ...
        mock_budget_data = {
            ...
            "remaining": 400.0,
            "status": "normal",
            "breakdown": {"compute": 300.0, "storage": 150.0, "network": 100.0, "other": 50.0},
        }
        mock_cost_functions["budget_status"].return_value = mock_budget_data
...
class TestIntegrationScenarios:
    ...
    def test_full_cost_monitoring_workflow(self, client, mock_cost_functions):
        ...
        # Check budget status
        mock_budget_data = {"budget": 1000.0, "used": 250.0, "remaining": 750.0, "status": "normal"}
        mock_cost_functions["budget_status"].return_value = mock_budget_data
    ...
    def test_budget_alert_workflow(self, client, mock_cost_functions):
        ...
        mock_forecast_data = [{"date": "2026-07-03", "predicted_amount": 150.0}]
        mock_cost_functions["forecast_costs"].return_value = mock_forecast_data
...
class TestDateFormats:
    ...
    def test_iso_date_format(self, client, mock_cost_functions):
        ...
        mock_cost_data = [{"date": "2026-07-01T00:00:00Z", "amount": 100.0}]
        mock_cost_functions["collect_costs"].return_value = mock_cost_data
...
class TestPerformanceScenarios:
    ...
    def test_large_dataset_handling(self, client, mock_cost_functions):
        ...
        mock_cost_data = [
            {"date": f"2026-07-{i%30+1:02d}", "amount": 100.0 + i} for i in range(1000)
        ]
        mock_cost_functions["collect_costs"].return_value = mock_cost_data
    ...
    def test_forecast_performance(self, client, mock_cost_functions):
        ...
        mock_forecast_data = [
            {"date": f"2026-07-{i:02d}", "predicted_amount": 100.0} for i in range(1, 366)
        ]
        mock_cost_functions["forecast_costs"].return_value = mock_forecast_data
