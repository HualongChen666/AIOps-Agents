...
class TestListChangeRequests:
    ...
    async def test_list_requests_permission_denied(self):
        ...
        # Setup
        with patch(
            "api.change_advanced_router.require_roles",
    ...
    async def test_list_requests_error_handling(self, mock_admin_user):
        ...
        # Setup
        with patch(
            "api.change_advanced_router.list_requests", side_effect=Exception("Database error")
        ):
            # Execute & Assert
            with patch("api.change_advanced_router.require_roles", return_value=mock_admin_user):
                with pytest.raises(HTTPException) as exc_info:
...
class TestCreateChangeRequest:
    ...
    async def test_create_request_permission_denied(
        self, sample_request_create, mock_business_user
    ):
    ...
    async def test_create_request_engine_error(self, sample_request_create, mock_admin_user):
        ...
        with patch(
            "api.change_advanced_router.create_request",
            side_effect=ChangeManagementError("Engine error"),
        ):
            # Execute & Assert
            with patch("api.change_advanced_router.require_roles", return_value=mock_admin_user):
                with pytest.raises(HTTPException) as exc_info:
...
class TestUpdateChangeRequest:
    ...
    async def test_update_request_success(
        self, sample_change_request, sample_request_update, mock_admin_user
    ):
        ...
        with patch("api.change_advanced_router.get_request", return_value=sample_change_request):
            with patch("api.change_advanced_router._persist", return_value=None):
                # Execute
                with patch(
                    "api.change_advanced_router.require_roles", return_value=mock_admin_user
                ):
    ...
    @pytest.mark.asyncio
    async def test_update_request_permission_denied(
        self, sample_request_update, mock_business_user
    ):
...
class TestListApprovals:
    ...
    @pytest.mark.asyncio
    async def test_list_approvals_success(
        self, sample_approval_request, mock_admin_user, clear_in_memory_data
    ):
...
class TestCreateApproval:
    ...
    async def test_create_approval_success(
        self, sample_approval_request, sample_change_request, mock_admin_user, clear_in_memory_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_approval_request_not_found(
        self, sample_approval_request, mock_admin_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_approval_permission_denied(
        self, sample_approval_request, mock_operator_user
    ):
...
class TestCreateSchedule:
    ...
    async def test_create_schedule_success(
        self, sample_schedule_request, sample_change_request, mock_admin_user, clear_in_memory_data
    ):
    ...
    async def test_create_schedule_invalid_time(
        self, sample_schedule_request, sample_change_request, mock_admin_user
    ):
        """Test creating schedule with invalid time range."""
        # Setup
        sample_schedule_request.scheduled_end = sample_schedule_request.scheduled_start - timedelta(
            hours=1
        )
        with patch("api.change_advanced_router.get_request", return_value=sample_change_request):
            # Execute & Assert
    ...
    @pytest.mark.asyncio
    async def test_create_schedule_request_not_found(
        self, sample_schedule_request, mock_admin_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_schedule_permission_denied(
        self, sample_schedule_request, mock_business_user
    ):
...
class TestPerformImpactAnalysis:
    ...
    @pytest.mark.asyncio
    async def test_impact_analysis_success(
        self, sample_impact_analysis_request, sample_change_request, mock_admin_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_impact_analysis_request_not_found(
        self, sample_impact_analysis_request, mock_admin_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_impact_analysis_permission_denied(
        self, sample_impact_analysis_request, mock_business_user
    ):
...
class TestCreateRollbackPlan:
    ...
    @pytest.mark.asyncio
    async def test_create_rollback_plan_success(
        self,
        sample_rollback_plan_request,
    ...
    @pytest.mark.asyncio
    async def test_create_rollback_plan_low_complexity(
        self, sample_change_request, mock_admin_user, clear_in_memory_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_rollback_plan_high_complexity(
        self, sample_change_request, mock_admin_user, clear_in_memory_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_rollback_plan_request_not_found(
        self, sample_rollback_plan_request, mock_admin_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_rollback_plan_permission_denied(
        self, sample_rollback_plan_request, mock_business_user
    ):
