...
def _patch_all_metrics(monkeypatch, dual_write_available=False, dual_init_fails=False):
    ...
    if dual_write_available:
        if dual_init_fails:
            ...
            original_init = (
                metrics_router.DualWriteStrategy
                if hasattr(metrics_router, "DualWriteStrategy")
                else None
            )
            if original_init:
                ...
                monkeypatch.setattr(
                    metrics_router, "DualWriteStrategy", MagicMock(side_effect=failing_init)
                )
        else:
            ...
            return_value=[
                {
                    "id": "1",
                    "visible": True,
                    "endpoint": "agent/decision-accuracy",
                    "field_path": "accuracy",
                    "name": "Accuracy",
                    "target": 0.9,
                    "unit": "",
            ...
            return_value=[
                {
                    "id": "1",
                    "visible": True,
                    "endpoint": "agent/feedback-accuracy",
                    "field_path": "accuracy",
                    "name": "Feedback",
                    "target": 0.8,
                    "unit": "",
...
def test_get_dashboard_metrics_high_alerts(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        "get_real_summary",
        AsyncMock(
            return_value={"total_alerts": 60, "heal_rate": 90, "mttd_min": 10, "rca_accuracy": 95}
        ),
    )
...
def test_get_dashboard_metrics_warning_alerts(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        "get_real_summary",
        AsyncMock(
            return_value={"total_alerts": 30, "heal_rate": 90, "mttd_min": 10, "rca_accuracy": 95}
        ),
    )
...
def test_get_dashboard_metrics_normal_alerts(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        "get_real_summary",
        AsyncMock(
            return_value={"total_alerts": 10, "heal_rate": 90, "mttd_min": 10, "rca_accuracy": 95}
        ),
    )
...
def test_get_dashboard_metrics_low_heal_rate(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        "get_real_summary",
        AsyncMock(
            return_value={"total_alerts": 10, "heal_rate": 70, "mttd_min": 10, "rca_accuracy": 95}
        ),
    )
...
def test_get_dashboard_metrics_high_mttd(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        "get_real_summary",
        AsyncMock(
            return_value={"total_alerts": 10, "heal_rate": 90, "mttd_min": 40, "rca_accuracy": 95}
        ),
    )
...
def test_get_dashboard_metrics_low_rca_accuracy(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        "get_real_summary",
        AsyncMock(
            return_value={"total_alerts": 10, "heal_rate": 90, "mttd_min": 10, "rca_accuracy": 80}
        ),
    )
...
def test_get_summary_with_logging(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        "get_real_summary",
        AsyncMock(
            return_value={"total_alerts": 42, "heal_rate": 85, "mttd_min": 15, "rca_accuracy": 92}
        ),
    )
...
def test_get_feedback_accuracy(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ai_feedback_router,
        "_compute_feedback_stats",
        MagicMock(return_value={"total": 100, "positive": 80, "negative": 20, "accuracy": 0.8}),
    )
...
def test_get_decision_accuracy_endpoint(client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        MagicMock(
            return_value={"precision": 0.9, "recall": 0.85, "f1_score": 0.87, "accuracy": 0.88}
        ),
    )
...
def test_kpi_config_create(client, monkeypatch):
    ...
    monkeypatch.setattr(
        metrics_router,
        "create_kpi_config",
        MagicMock(return_value={"id": "new-1", "name": "New Config"}),
    )
