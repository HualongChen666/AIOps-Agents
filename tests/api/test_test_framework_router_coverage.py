...
def test_framework_app(mock_test_framework_manager):
    ...
    with patch('core.test_framework_manager.get_test_framework_manager', return_value=mock_test_framework_manager):
        yield app
...
class TestGetFrameworkStatus:
    ...
    def test_get_framework_status_import_error(self, client, mock_test_framework_manager):
        ...
        with patch('core.test_framework_manager.get_test_framework_manager', side_effect=ImportError("Import failed")):
            response = client.get("/api/test-framework/status")
...
class TestRunTestSuite:
    ...
    def test_run_test_suite_http_exception(self, client, mock_test_framework_manager):
        ...
        mock_test_framework_manager.run_test_suite.side_effect = HTTPException(status_code=404, detail="Not found")
