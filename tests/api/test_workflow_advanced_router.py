...
class TestWorkflowDefinitions:
    ...
    @pytest.mark.asyncio
    async def test_create_workflow_definition_success(self, sample_workflow_definition, mock_request, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_create_workflow_definition_duplicate(self, sample_workflow_definition, mock_request, mock_repository):
    ...
    async def test_create_workflow_definition_validation_error(self, mock_request):
        ...
        with pytest.raises(Exception):  # Pydantic validation error
            WorkflowDefinitionCreate(
                workflow_id="",  # Empty string should fail validation
                name="Test"
            )
    ...
    @pytest.mark.asyncio
    async def test_update_workflow_definition_success(self, sample_workflow_definition, mock_request, mock_repository):
...
class TestWorkflowExecutions:
    ...
    async def test_list_workflow_executions_with_status_filter(self, mock_repository):
        ...
        from api.workflow_advanced_router import list_workflow_executions
        from extensions.addons.operations.workflow_service.schemas import WorkflowTask, WorkflowStatus
    ...
    @pytest.mark.asyncio
    async def test_create_workflow_execution_success(self, sample_workflow_execution, mock_request, mock_orchestrator):
        ...
        with patch('api.workflow_advanced_router._get_orchestrator', return_value=mock_orchestrator):
            mock_task = Mock(spec=WorkflowTask)
    ...
    @pytest.mark.asyncio
    async def test_create_workflow_execution_invalid_workflow(self, sample_workflow_execution, mock_request, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_start_workflow_execution_success(self, mock_request, mock_repository, mock_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_resume_workflow_execution_success(self, mock_request, mock_repository, mock_orchestrator):
...
class TestSchedules:
    ...
    async def test_get_schedule_success(self, sample_schedule):
        ...
        from api.workflow_advanced_router import get_schedule, create_schedule
    ...
    async def test_update_schedule_success(self, sample_schedule, mock_request):
        ...
        from api.workflow_advanced_router import update_schedule, create_schedule
    ...
    async def test_delete_schedule_success(self, sample_schedule, mock_request):
        ...
        from api.workflow_advanced_router import delete_schedule, create_schedule
    ...
    async def test_enable_schedule_success(self, sample_schedule, mock_request):
        ...
        from api.workflow_advanced_router import enable_schedule, create_schedule
    ...
    async def test_disable_schedule_success(self, sample_schedule, mock_request):
        ...
        from api.workflow_advanced_router import disable_schedule, create_schedule
...
class TestTriggers:
    ...
    async def test_get_trigger_success(self, sample_trigger, mock_request):
        ...
        from api.workflow_advanced_router import get_trigger, create_trigger
    ...
    async def test_update_trigger_success(self, sample_trigger, mock_request):
        ...
        from api.workflow_advanced_router import update_trigger, create_trigger
    ...
    async def test_delete_trigger_success(self, sample_trigger, mock_request):
        ...
        from api.workflow_advanced_router import delete_trigger, create_trigger
...
class TestVariables:
    ...
    async def test_get_variable_success(self, sample_variable, mock_request):
        ...
        from api.workflow_advanced_router import get_variable, create_variable
    ...
    async def test_update_variable_success(self, sample_variable, mock_request):
        ...
        from api.workflow_advanced_router import update_variable, create_variable
    ...
    async def test_delete_variable_success(self, sample_variable, mock_request):
        ...
        from api.workflow_advanced_router import delete_variable, create_variable
...
class TestAuditLogs:
    ...
    async def test_list_audit_logs_with_action_filter(self):
        ...
        from api.workflow_advanced_router import list_audit_logs, _audit_logs
...
class TestStatistics:
    ...
    async def test_get_statistics_success(self, mock_repository):
        ...
        from extensions.addons.operations.workflow_service.schemas import WorkflowDefinition, WorkflowTask, WorkflowStatus
    ...
    async def test_get_statistics_with_data(self, mock_repository):
        ...
        with patch('api.workflow_advanced_router._get_repository', return_value=mock_repository):
            ...
            mock_repository.list_tasks = AsyncMock(return_value=[mock_task_success, mock_task_failed])
...
class TestDataValidation:
    ...
    def test_workflow_definition_create_invalid_long_name(self):
        ...
        with pytest.raises(Exception):
            WorkflowDefinitionCreate(
                workflow_id="test-1",
                name="x" * 129  # Exceeds max_length=128
            )
...
class TestIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_workflow_lifecycle(self, sample_workflow_definition, mock_request, mock_repository):
