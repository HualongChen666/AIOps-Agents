...
class TestCollectCosts:
    ...
    def test_collect_costs_aws_success(self):
        ...
        with patch("core.cost_monitor.boto3", mock_boto3):
            result = collect_costs()
...
class TestBudgetStatus:
    ...
    def test_budget_status_healthy(self):
        ...
        current_month_costs = [
            {"cost": 1000.0, "timestamp": "2024-01-01"},
            {"cost": 500.0, "timestamp": "2024-01-15"},
        ]

        with patch("core.cost_monitor.collect_costs", return_value=current_month_costs):
            with patch("core.cost_monitor.datetime") as mock_datetime:
    ...
    def test_budget_status_warning(self):
        ...
        current_month_costs = [{"cost": 4000.0, "timestamp": "2024-01-01"}]
    ...
    def test_budget_status_critical(self):
        ...
        current_month_costs = [{"cost": 4600.0, "timestamp": "2024-01-01"}]
    ...
    def test_budget_status_recommendations(self):
        ...
        current_month_costs = [{"cost": 4200.0, "timestamp": "2024-01-01"}]
        ...
        with patch("core.cost_monitor.collect_costs", return_value=current_month_costs):
            with patch("core.cost_monitor.datetime") as mock_datetime:
                ...
                assert len(result["recommendations"]) > 0
                assert any("resource usage" in r.lower() for r in result["recommendations"])
    ...
    def test_budget_status_zero_budget(self):
        ...
        current_month_costs = [{"cost": 100.0, "timestamp": "2024-01-01"}]
        ...
        with patch("core.cost_monitor.collect_costs", return_value=current_month_costs):
            with patch("core.cost_monitor.datetime") as mock_datetime:
                ...
                # This would require modifying the function to accept budget parameter
