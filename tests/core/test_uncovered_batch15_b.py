...
class TestAccessibilitySupport:
    def test_add_accessibility_headers(self):
        response = Response()
        result = accessibility_support.AccessibilityHeaders.add_accessibility_headers(response)
    ...
    def test_add_a11y_metadata(self):
        ...
        result = accessibility_support.AccessibilityHeaders.add_a11y_metadata(response, metadata)
        assert result is response
    ...
    def test_accessibility_audit(self):
        ...
        result = accessibility_support.AccessibilityAudit.audit_response_data(data)
...
class TestApiDeprecation:
    ...
    async def test_deprecation_middleware_adds_headers(self, monkeypatch):
        ...
        result = await api_deprecation.deprecation_middleware(request, call_next)
        assert result is response
...
class TestCollaborationEngine:
    ...
    def test_resolve_workspace(self, fresh_collab):
        ...
        result = fresh_collab.resolve_workspace(ws["id"])
...
class TestServiceDiscoveryManager:
    ...
    async def test_health_check_exception(self, fresh_discovery, monkeypatch):
        ...
        result = await fresh_discovery.health_check(inst)
