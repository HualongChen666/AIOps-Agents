...
def test_send_slack_approval_request_disabled():
    async def _run():
        collab = CollaborationIntegration()
        result = await collab.send_slack_approval_request(
            "title", "desc"
        )  # noqa: F841  # Variable for test verification
        assert result == {
            "error": "Slack not enabled"
...
def test_slack_notification_success_and_channel_override(collab_server):
    async def _run():
        ...
        result = (
            await collab.send_slack_notification(  # noqa: F841  # Variable for test verification
                "hello",
                channel="#override",
...
def test_teams_approval_card_server_error(collab_server):
    async def _run():
        ...
        result = (
            await collab.send_teams_approval_card(  # noqa: F841  # Variable for test verification
