# -*- coding: utf-8 -*-
"""API tests for the Alert Rule microservice."""
...
from services.alert_rule_service import config
from services.alert_rule_service import main_app as main_module
from services.alert_rule_service.config import settings
from services.alert_rule_service.main_app import app
from services.alert_rule_service.metrics import MetricsCollector
from services.alert_rule_service.service import OPERATIONS, Service
...
async def reset_service():
    ...
    metrics = MetricsCollector(f"alert_rule_api_test_{uuid.uuid4().hex[:6]}")
