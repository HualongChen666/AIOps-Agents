# -*- coding: utf-8 -*-
"""API tests for the Chaos Mesh microservice."""
...
from services.chaos_mesh_service import config
from services.chaos_mesh_service import main_app as main_module
from services.chaos_mesh_service.config import settings
from services.chaos_mesh_service.main_app import app
from services.chaos_mesh_service.metrics import MetricsCollector
from services.chaos_mesh_service.service import OPERATIONS, Service
...
async def reset_service():
    ...
    metrics = MetricsCollector(f"chaos_mesh_api_test_{uuid.uuid4().hex[:6]}")
