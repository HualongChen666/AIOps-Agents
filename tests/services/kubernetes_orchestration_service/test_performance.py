# -*- coding: utf-8 -*-
"""Performance benchmark for the Kubernetes Orchestration microservice."""
...
import services.kubernetes_orchestration_service.config as config_module
...
async def test_operation_throughput():
    ...
    metrics = MetricsCollector(f"kubernetes_orchestration_perf_{uuid.uuid4().hex[:6]}")
