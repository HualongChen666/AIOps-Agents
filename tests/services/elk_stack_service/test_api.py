# -*- coding: utf-8 -*-
"""API tests for the ELK Stack microservice."""
...
from services.elk_stack_service import config
from services.elk_stack_service import main_app as main_module
from services.elk_stack_service.config import settings
from services.elk_stack_service.main_app import app
from services.elk_stack_service.metrics import MetricsCollector
from services.elk_stack_service.service import OPERATIONS, Service
...
async def reset_service():
    ...
    metrics = MetricsCollector(f"elk_stack_api_test_{uuid.uuid4().hex[:6]}")
