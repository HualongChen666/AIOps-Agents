# -*- coding: utf-8 -*-
"""gRPC client/server tests for the ELK Stack microservice."""
...
from services.elk_stack_service.grpc.client import ELKStackServiceRPCClient
from services.elk_stack_service.grpc.server import ELKStackServiceRPCServer


@pytest.mark.asyncio
async def test_rpc_server_register_and_call():
    server = ELKStackServiceRPCServer()
...
async def test_rpc_client_call():
    client = ELKStackServiceRPCClient(base_url="http://test")
