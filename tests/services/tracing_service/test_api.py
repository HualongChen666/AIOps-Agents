# -*- coding: utf-8 -*-
"""API tests for the Tracing microservice."""
...
from services.tracing_service import config
from services.tracing_service import main_app as main_module
from services.tracing_service.config import settings
from services.tracing_service.main_app import app
from services.tracing_service.metrics import MetricsCollector
from services.tracing_service.service import OPERATIONS, Service
...
async def reset_service():
    ...
    metrics = MetricsCollector(f"tracing_api_test_{uuid.uuid4().hex[:6]}")
