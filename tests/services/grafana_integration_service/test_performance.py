# -*- coding: utf-8 -*-
"""Performance benchmark for the Grafana Integration microservice."""
...
import services.grafana_integration_service.config as config_module
...
async def test_operation_throughput():
    ...
    metrics = MetricsCollector(f"grafana_integration_perf_{uuid.uuid4().hex[:6]}")
