# -*- coding: utf-8 -*-
"""gRPC client/server tests for the Ansible Automation microservice."""
...
from services.ansible_automation_service.grpc.client import AnsibleAutomationServiceRPCClient
from services.ansible_automation_service.grpc.server import AnsibleAutomationServiceRPCServer


@pytest.mark.asyncio
async def test_rpc_server_register_and_call():
    server = AnsibleAutomationServiceRPCServer()
...
async def test_rpc_client_call():
    client = AnsibleAutomationServiceRPCClient(base_url="http://test")
