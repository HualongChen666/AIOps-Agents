# -*- coding: utf-8 -*-
"""gRPC client/server tests for the Terraform IaC microservice."""
...
from services.terraform_iac_service.grpc.client import TerraformIaCServiceRPCClient
from services.terraform_iac_service.grpc.server import TerraformIaCServiceRPCServer


@pytest.mark.asyncio
async def test_rpc_server_register_and_call():
    server = TerraformIaCServiceRPCServer()
...
async def test_rpc_client_call():
    client = TerraformIaCServiceRPCClient(base_url="http://test")
