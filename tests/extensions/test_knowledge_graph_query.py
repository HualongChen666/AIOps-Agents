...
class TestGraphQueryEngine:
    ...
    def sample_nodes(self):
        ...
        return [
            ...
            GraphNode(
                node_id="node4", label="Service 1", node_type="service", properties={"name": "svc1"}
            ),
            GraphNode(
                node_id="node5",
    ...
    def test_query_default(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id=None, relation=None, depth=2, top_k=3
        )
    ...
    def test_query_default_top_k_all(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id=None, relation=None, depth=2, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_entity_basic(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id="node1", relation=None, depth=1, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_entity_depth_0(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id="node1", relation=None, depth=0, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_entity_depth_2(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id="node1", relation=None, depth=2, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_entity_nonexistent(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id="nonexistent", relation=None, depth=2, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_entity_with_top_k(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id="node1", relation=None, depth=2, top_k=2
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_relation(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id=None, relation="connects", depth=2, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_relation_single_edge(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id=None, relation="hosts", depth=2, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_relation_nonexistent(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id=None, relation="nonexistent", depth=2, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_by_relation_connected_nodes(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id=None, relation="depends_on", depth=2, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_bidirectional_edges(self, engine, sample_nodes, sample_edges):
        ...
        edges = sample_edges + [
            GraphEdge(
                edge_id="edge6", source_id="node3", target_id="node2", relation="reverse_depends"
            )
        ]

        request = GraphQueryRequest(
            graph_id="graph1", entity_id="node2", relation=None, depth=1, top_k=10
        )
    ...
    def test_query_empty_nodes_with_edges(self, engine):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id=None, relation="test", depth=2, top_k=10
        )
    ...
    def test_find_shortest_path_no_path(self, engine, sample_nodes, sample_edges):
        ...
        # Add isolated node
        nodes = sample_nodes + [
            GraphNode(node_id="isolated", label="Isolated", node_type="test", properties={})
        ]
    ...
    def test_query_entity_id_priority_over_relation(self, engine, sample_nodes, sample_edges):
        ...
        request = GraphQueryRequest(
            graph_id="graph1", entity_id="node1", relation="connects", depth=1, top_k=10
        )
        result = engine.query("graph1", sample_nodes, sample_edges, request)
    ...
    def test_query_complex_graph(self, engine):
        ...
        edges = [
            GraphEdge(
                edge_id=f"edge{i}", source_id=f"node{i}", target_id=f"node{i+1}", relation="link"
            )
            for i in range(9)
        ]

        request = GraphQueryRequest(
            graph_id="complex_graph", entity_id="node0", relation=None, depth=3, top_k=10
        )
    ...
    def test_query_with_circular_dependencies(self, engine):
        ...
        request = GraphQueryRequest(
            graph_id="circular_graph", entity_id="a", relation=None, depth=5, top_k=10
        )
    ...
    def test_query_disconnected_components(self, engine):
        ...
        request = GraphQueryRequest(
            graph_id="disconnected_graph", entity_id="a1", relation=None, depth=2, top_k=10
        )
