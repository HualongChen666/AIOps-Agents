...
def test_connector_bus_unsupported_bus(monkeypatch):
    """Test unsupported bus types in produce and consume methods."""
    monkeypatch.setenv("INFRA_EXECUTE_ENABLED", "true")
...
def test_connector_bus_produce_consume_errors(monkeypatch):
...
def test_connector_bus_sqs_url_detection():
    ...
    assert _sqs_url("kafka://localhost:9092/topic") is False
