...
class TestGraphStore:
    ...
    async def test_connect_no_neo4j_available(self):
        ...
        with patch('extensions.addons.ai_plus.knowledge_graph_service.graph_store._NEO4J_AVAILABLE', False):
    ...
    async def test_connect_success(self):
        ...
        with patch('extensions.addons.ai_plus.knowledge_graph_service.graph_store._NEO4J_AVAILABLE', True):
            with patch('extensions.addons.ai_plus.knowledge_graph_service.graph_store.neo4j') as mock_neo4j:
    ...
    async def test_add_edge_with_id(self):
        ...
        store = GraphStore()
        edge = GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={})
    ...
    async def test_add_edge_without_id(self):
        ...
        store = GraphStore()
        edge = GraphEdge(edge_id="", source_id="node1", target_id="node2", relation="connects", properties={})
    ...
    async def test_get_neighbors(self):
        ...
        store = GraphStore()
        edge1 = GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={})
        edge2 = GraphEdge(edge_id="edge2", source_id="node1", target_id="node3", relation="connects", properties={})
        edge3 = GraphEdge(edge_id="edge3", source_id="node2", target_id="node4", relation="connects", properties={})
    ...
    async def test_get_neighbors_no_edges(self):
        ...
        store = GraphStore()
        edge = GraphEdge(edge_id="edge1", source_id="node2", target_id="node3", relation="connects", properties={})
        store._edges = [edge]
    ...
    async def test_query_edges_no_filter(self):
        ...
        store = GraphStore()
        edge1 = GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={})
        edge2 = GraphEdge(edge_id="edge2", source_id="node2", target_id="node3", relation="depends", properties={})
    ...
    async def test_query_edges_by_relation(self):
        ...
        edge1 = GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={})
        edge2 = GraphEdge(edge_id="edge2", source_id="node2", target_id="node3", relation="depends", properties={})
        edge3 = GraphEdge(edge_id="edge3", source_id="node3", target_id="node4", relation="connects", properties={})
        store._edges = [edge1, edge2, edge3]
    ...
    def test_collect_nodes(self):
        ...
        edge1 = GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={})
        edge2 = GraphEdge(edge_id="edge2", source_id="node2", target_id="node3", relation="connects", properties={})
    ...
    async def test_find_paths_no_path(self):
        ...
        store = GraphStore()
        edge1 = GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={})
        edge2 = GraphEdge(edge_id="edge2", source_id="node3", target_id="node4", relation="connects", properties={})
        store._edges = [edge1, edge2]
    ...
    async def test_find_paths_multiple_paths(self):
        ...
        edge2 = GraphEdge(edge_id="edge2", source_id="node1", target_id="node3", relation="connects", properties={})
        edge3 = GraphEdge(edge_id="edge3", source_id="node2", target_id="node4", relation="connects", properties={})
        edge4 = GraphEdge(edge_id="edge4", source_id="node3", target_id="node4", relation="connects", properties={})
    ...
    async def test_load_graph(self):
        ...
        graph = Graph(
            ...
            edges=[
                GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={}),
            ],
        )
    ...
    async def test_clear(self):
        ...
        store = GraphStore()
        store._nodes = {"node1": GraphNode(node_id="node1", label="Test", node_type="test", properties={})}
        store._edges = [GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={})]
    ...
    async def test_integration_add_and_query(self):
        ...
        node1 = GraphNode(node_id="node1", label="Server", node_type="infrastructure", properties={"ip": "192.168.1.1"})
        node2 = GraphNode(node_id="node2", label="Database", node_type="infrastructure", properties={"ip": "192.168.1.2"})
        
        await store.add_node(node1)
        await store.add_node(node2)
        
        edge = GraphEdge(edge_id="edge1", source_id="node1", target_id="node2", relation="connects", properties={"protocol": "tcp"})
