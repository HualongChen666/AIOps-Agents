...
class PerformanceRegressionAnalyzer:
    ...
    def analyze_benchmark_results(
        self,
        baseline_benchmarks: Dict[str, Any],
        current_benchmarks: Dict[str, Any]
    ...
    def analyze_performance_metrics(
        ...
        if "throughput_ops_per_sec" in baseline_report and "throughput_ops_per_sec" in current_report:
            result = self.compare_metric(
    ...
    def analyze_full_report(
        ...
        if "benchmarks" in baseline_report and "benchmarks" in current_report:
            bench_results = self.analyze_benchmark_results(
                baseline_report["benchmarks"],
                current_report["benchmarks"]
            )
...
def main():
    ...
    parser.add_argument("--min-samples", type=int, default=3,
                       help="Minimum samples for statistical significance")
