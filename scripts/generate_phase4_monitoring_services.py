#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate Phase 4 monitoring and infrastructure integration microservices for tasks 62-69."""
...
SERVICES: List[Dict[str, Any]] = [
    {
        ...
        "port": 9530,
        "prom_port": 9630,
        "url_prefix": "prometheus-integration",
        "operations": [
    ...
    },
    {
        ...
        "display": "Grafana Integration",
        "port": 9531,
        "prom_port": 9631,
        "url_prefix": "grafana-integration",
        "operations": [
            "manage-dashboards",
    ...
    },
    {
        ...
        "display": "Datadog Integration",
        "port": 9533,
        "prom_port": 9633,
        "url_prefix": "datadog-integration",
        "operations": [
    ...
    },
    {
        ...
        "display": "Ansible Automation",
        "port": 9535,
        "prom_port": 9635,
        "url_prefix": "ansible-automation",
        "operations": [
    ...
    {
        "name": "terraform_iac",
        "display": "Terraform IaC",
        "port": 9536,
        "prom_port": 9636,
        "url_prefix": "terraform-iac",
        "operations": [
