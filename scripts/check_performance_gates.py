            ...
            try:
                ...
                if coverage_elem is not None:
                    ...
                    if coverage_percent < coverage_threshold:
                        ...
                        messages.append(f"Coverage {coverage_percent:.2f}% meets threshold {coverage_threshold}%")
