...
# flake8: noqa
# isort: skip_file
"""Comprehensive 13-dimension verification for tasks 62-69 with per-service coverage."""
...
JSON_OUT = OUT_DIR / "tasks_62_69_final_verification.json"
MD_OUT = OUT_DIR / "tasks_62_69_final_report.md"
...
TASKS = [
    ...
    ("68", "terraform_iac_service", "Terraform IaC（任务68）"),
