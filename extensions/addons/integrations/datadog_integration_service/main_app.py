# -*- coding: utf-8 -*-
"""FastAPI application for the Datadog Integration microservice."""
...
from .service import DatadogIntegrationService as ServiceClass
...
app = FastAPI(
    title="Datadog Integration Service",
    description="FastAPI microservice for Datadog Integration.",
    version="0.1.0",
)
...
@app.post("/datadog-integration/{path}", response_model=FeatureResponse)
