# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Datadog Integration microservice."""
...
class DatadogIntegrationServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9533") -> None:
