# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Elasticsearch Audit microservice."""
...
class ElasticsearchAuditServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9542") -> None:
