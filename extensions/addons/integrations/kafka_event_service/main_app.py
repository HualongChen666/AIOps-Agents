# -*- coding: utf-8 -*-
"""FastAPI application for the Kafka Event microservice."""
...
from .service import KafkaEventService as ServiceClass
...
app = FastAPI(
    title="Kafka Event Service",
    description="FastAPI microservice for Kafka Event.",
    version="0.1.0",
)
...
@app.post("/kafka-event/{path}", response_model=FeatureResponse)
