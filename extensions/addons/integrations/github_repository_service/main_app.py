# -*- coding: utf-8 -*-
"""FastAPI application for the GitHub Repository microservice."""
...
from .service import GitHubRepositoryService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for GitHub Repository.",
    version="0.1.0",
)
...
@app.post("/github-repository/{path}", response_model=FeatureResponse)
