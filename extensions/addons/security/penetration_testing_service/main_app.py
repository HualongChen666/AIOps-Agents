# -*- coding: utf-8 -*-
"""FastAPI application for the Penetration Testing microservice."""
...
from .service import PenetrationTestingService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Penetration Testing.",
    version="0.1.0",
)
...
@app.post("/penetration-testing/{path}", response_model=FeatureResponse)
