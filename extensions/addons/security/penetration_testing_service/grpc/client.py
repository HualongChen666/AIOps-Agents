# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Penetration Testing microservice."""
...
class PenetrationTestingServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9564") -> None:
