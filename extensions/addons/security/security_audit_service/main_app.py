# -*- coding: utf-8 -*-
"""FastAPI application for the Security Audit microservice."""
...
from .service import SecurityAuditService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Security Audit.",
    version="0.1.0",
)
...
@app.post("/security-audit/{path}", response_model=FeatureResponse)
