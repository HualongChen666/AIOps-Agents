# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the SQLAlchemy Security microservice."""
...
class SQLAlchemySecurityServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9541") -> None:
