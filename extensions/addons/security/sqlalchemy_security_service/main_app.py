# -*- coding: utf-8 -*-
"""FastAPI application for the SQLAlchemy Security microservice."""
...
from .service import SQLAlchemySecurityService as ServiceClass
...
app = FastAPI(
    title="SQLAlchemy Security Service",
    description="FastAPI microservice for SQLAlchemy Security.",
    version="0.1.0",
)
...
@app.post("/sqlalchemy-security/{path}", response_model=FeatureResponse)
