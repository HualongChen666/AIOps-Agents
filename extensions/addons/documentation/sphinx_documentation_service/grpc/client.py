# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Sphinx Documentation microservice."""
...
class SphinxDocumentationServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9550") -> None:
