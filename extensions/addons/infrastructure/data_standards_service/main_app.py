# -*- coding: utf-8 -*-
"""FastAPI application for the Data Standards microservice."""
...
from .service import DataStandardsService as ServiceClass
...
app = FastAPI(
    title="Data Standards Service",
    description="FastAPI microservice for Data Standards.",
    version="0.1.0",
)
...
@app.post("/data-standards/{path}", response_model=FeatureResponse)
