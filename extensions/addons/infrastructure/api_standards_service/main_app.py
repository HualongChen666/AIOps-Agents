# -*- coding: utf-8 -*-
"""FastAPI application for the API Standards microservice."""
...
from .service import APIStandardsService as ServiceClass
...
app = FastAPI(
    title="API Standards Service",
    description="FastAPI microservice for API Standards.",
    version="0.1.0",
)
...
@app.post("/api-standards/{path}", response_model=FeatureResponse)
