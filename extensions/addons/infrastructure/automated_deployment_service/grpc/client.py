# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Automated Deployment microservice."""
...
class AutomatedDeploymentServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9565") -> None:
