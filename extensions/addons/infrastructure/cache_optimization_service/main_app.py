# -*- coding: utf-8 -*-
"""FastAPI application for the Cache Optimization microservice."""
...
from .service import CacheOptimizationService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Cache Optimization.",
    version="0.1.0",
)
...
@app.post("/cache-optimization/{path}", response_model=FeatureResponse)
