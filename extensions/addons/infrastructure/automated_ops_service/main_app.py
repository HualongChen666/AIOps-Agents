# -*- coding: utf-8 -*-
"""FastAPI application for the Automated Operations microservice."""
...
from .service import AutomatedOperationsService as ServiceClass
...
app = FastAPI(
    title="Automated Operations Service",
    description="FastAPI microservice for Automated Operations.",
    version="0.1.0",
)
...
@app.post("/automated-ops/{path}", response_model=FeatureResponse)
