# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Kubernetes Orchestration microservice."""
...
class KubernetesOrchestrationServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9537") -> None:
