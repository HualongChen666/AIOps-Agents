# -*- coding: utf-8 -*-
"""FastAPI application for the Service Mesh microservice."""
...
from .service import ServiceMeshService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Service Mesh.",
    version="0.1.0",
)
...
@app.post("/service-mesh/{path}", response_model=FeatureResponse)
