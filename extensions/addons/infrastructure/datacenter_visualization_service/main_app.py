# -*- coding: utf-8 -*-
"""FastAPI application for the Datacenter Visualization microservice."""
...
from .service import DatacenterVisualizationService as ServiceClass
...
app = FastAPI(
    title="Datacenter Visualization Service",
    description="FastAPI microservice for Datacenter Visualization.",
    version="0.1.0",
)
...
@app.post("/datacenter-visualization/{path}", response_model=FeatureResponse)
