# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Ansible Automation microservice."""
...
class AnsibleAutomationServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9535") -> None:
