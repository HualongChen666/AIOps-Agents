# -*- coding: utf-8 -*-
"""FastAPI application for the Open Source License microservice."""
...
from .service import OpenSourceLicenseService as ServiceClass
...
app = FastAPI(
    title="Open Source License Service",
    description="FastAPI microservice for Open Source License.",
    version="0.1.0",
)
...
@app.post("/open-source-license/{path}", response_model=FeatureResponse)
