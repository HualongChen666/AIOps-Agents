# -*- coding: utf-8 -*-
"""FastAPI application for the Alert Rule microservice."""
...
from .service import AlertRuleService as ServiceClass
...
app = FastAPI(
    title="Alert Rule Service",
    description="FastAPI microservice for Alert Rule.",
    version="0.1.0",
)
...
@app.post("/alert-rule/{path}", response_model=FeatureResponse)
