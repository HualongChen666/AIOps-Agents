# -*- coding: utf-8 -*-
"""FastAPI application for the Plugin Market microservice."""
...
from .service import PluginMarketService as ServiceClass
...
app = FastAPI(
    title="Plugin Market Service",
    description="FastAPI microservice for Plugin Market.",
    version="0.1.0",
)
...
@app.post("/plugin-market/{path}", response_model=FeatureResponse)
