# -*- coding: utf-8 -*-
"""FastAPI application for the Backup Recovery Drill microservice."""
...
from .service import BackupRecoveryDrillService as ServiceClass
...
app = FastAPI(
    title="Backup Recovery Drill Service",
    description="FastAPI microservice for Backup Recovery Drill.",
    version="0.1.0",
)
...
@app.post("/backup-recovery-drill/{path}", response_model=FeatureResponse)
