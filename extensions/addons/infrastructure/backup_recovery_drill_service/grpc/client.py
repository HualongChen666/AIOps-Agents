# -*- coding: utf-8 -*-
"""gRPC-like HTTP client for the Backup Recovery Drill microservice."""
...
class BackupRecoveryDrillServiceRPCClient:
    """HTTP-based RPC client."""

    def __init__(self, base_url: str = "http://localhost:9552") -> None:
