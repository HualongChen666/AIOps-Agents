# -*- coding: utf-8 -*-
"""Saga distributed transaction orchestrator for topology service."""
...
from services.topology_service.metrics import TOPOLOGY_SAGA_STATUS
from services.topology_service.schemas import SagaStep, SagaTransaction

SagaAction = Callable[..., Any]
SagaCompensation = Callable[..., Any]


class TopologySagaOrchestrator:
    ...
    async def execute(self, saga_id: str) -> Dict[str, Any]:
        ...
        TOPOLOGY_SAGA_STATUS.labels(saga_id=saga_id).set(0)
        executed: List[str] = []
        ...
        for step in transaction.steps:
            ...
            if not action:
                ...
                TOPOLOGY_SAGA_STATUS.labels(saga_id=saga_id).set(2)
        ...
        TOPOLOGY_SAGA_STATUS.labels(saga_id=saga_id).set(1)
    ...
    async def _compensate(self, saga_id: str, executed_steps: List[str]) -> None:
        ...
        TOPOLOGY_SAGA_STATUS.labels(saga_id=saga_id).set(3)
