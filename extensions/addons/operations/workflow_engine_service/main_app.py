# -*- coding: utf-8 -*-
"""FastAPI application for the Workflow Engine microservice."""
...
from .service import WorkflowEngineService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Workflow Engine.",
    version="0.1.0",
)
...
@app.post("/workflow-engine/{path}", response_model=FeatureResponse)
