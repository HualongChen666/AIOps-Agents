# -*- coding: utf-8 -*-
"""FastAPI application for the Incident Response microservice."""
...
from .service import IncidentResponseService as ServiceClass
...
app = FastAPI(
    ...
    description="FastAPI microservice for Incident Response.",
    version="0.1.0",
)
...
@app.post("/incident-response/{path}", response_model=FeatureResponse)
