# -*- coding: utf-8 -*-
"""FastAPI application for the Incident Runbook microservice."""
...
from .service import IncidentRunbookService as ServiceClass
...
app = FastAPI(
    title="Incident Runbook Service",
    description="FastAPI microservice for Incident Runbook.",
    version="0.1.0",
)
...
@app.post("/incident-runbook/{path}", response_model=FeatureResponse)
